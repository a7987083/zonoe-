...
static NSArray<NSString *> *ZONBundledModuleDirectories(void) {
...
static BOOL ZONPathIsInsideDirectory(NSString *path, NSString *directory) {
...
static BOOL ZONLoadModuleAtPath(NSString *path, NSMutableSet<NSString *> *loadedIdentifiers) {
