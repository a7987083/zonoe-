...
//    [currentwindow presentViewController:picker animated:YES completion:nil];
        [[JHPP currentViewController] presentViewController:picker animated:YES completion:nil];
