...
static inline void ZONCoreLog(ZONLogLevel level, const char *moduleID, const char *message) {
...
static inline const ZONHostAPI *ZONGetHostAPI(void) {
...
static inline NSArray<NSString *> *ZONBundledModuleDirectories(void) {
...
static inline BOOL ZONPathIsInsideDirectory(NSString *path, NSString *directory) {
...
static inline BOOL ZONLoadModuleAtPath(NSString *path, NSMutableSet<NSString *> *loadedIdentifiers) {
...
static inline void ZONLoadBundledModules(void) {
