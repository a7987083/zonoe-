...
#define  BSPHP_HOST  @"https://yz.zonoeios.xyz/AppEn.php?appid=79870831&m=43937d8c188a8d869852c73abf854735"

//通信认证Key
#define BSPHP_MUTUALKEY @"cd4ace5ee873ce380b2edcd10bb4e297"
//接收Sgin验证 注意必须填写 并且有[KEY]
#define BSPHP_INSGIN @"[KEY]inz23456"
//输出Sgin验证 注意必须填写 并且有[KEY]
#define BSPHP_TOSGIN @"[KEY]toy56789"
//数据加密密码
#define BSPHP_PASSWORD @"4zQ75Q4YqRRPg09D3L"
...
#define  UDID_HOST  @"https://yz.zonoeios.xyz/udid/"

//启动APP后多少秒开始验证 单位秒 ** 因为很多游戏有启动画面 启动动画 会刷新UI 刷掉弹窗 相当于没了验证 比如光遇 王者荣耀 等 要等启动动画结束才弹窗 自己测试时间
#define BS延迟启动时间 5

#define homeurl @"https://yun.zonoeios.xyz/d/a/json/"
#define homezip @"https://yun.zonoeios.xyz/d/a/yuncundang/"

#define homeurlx @"https://yun.zonoeios.xyz/d/a/txt/"
