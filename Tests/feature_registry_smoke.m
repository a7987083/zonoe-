...
int main(void)
{
    @autoreleasepool {
        ...
        require(migratedCount == 10, @"v1_p21 must keep all ten features registry-owned");
        ...
        NSLog(@"feature registry smoke passed (v1_p21, 10 features, 3 registry-driven sections)");
    }
    return 0;
}
