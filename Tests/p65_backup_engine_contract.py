...
if version not in {'v1_p65', 'v1_p66', 'v1_p67', 'v1_p67a', 'v1_p68', 'v1_p69', 'v1_p70', 'v1_p71', 'v1_p72'}:
...
if version in {'v1_p70', 'v1_p71', 'v1_p72'}:
...
if version in {'v1_p70', 'v1_p71', 'v1_p72'} and pbx.count('ZONBackupCoordinator.m in Sources') != 2:
