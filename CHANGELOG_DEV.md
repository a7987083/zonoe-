...
- p28 device/runtime regression remains pending; p27 remains the device-verified baseline until p28 passes on hardware.
...
- p27 was promoted to the device-verified baseline.
